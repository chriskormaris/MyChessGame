...
public class GuiConstants {
	...
	public static final String RULES = "The game of Chess is strictly played by 2 players and consists of 16 White and 16 Black pieces.\n"
			...
			+ "     Also, if we have only Kings and Pawns left on the Chess board and the Kings are not able to capture the Pawns,\n"
			...
			+ "  5) If the exact game board position is repeated 3 times, at any time in the game, not necessarily successively,\n"
			+ "     then the player that plays next can declare a draw. This case is called threefold repetition.\n"
			+ "  6) If the exact game board position is repeated 5 times, at any time in the game, not necessarily successively,\n"
			+ "     then the game automatically ends in a draw. This case is called fivefold repetition.\n"
