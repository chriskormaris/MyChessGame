...
public class PeSTOEvaluationUtils {
	...
	public final int PAWN_OPENING_CENTIPAWN_VALUE = 82;
	public final int KNIGHT_OPENING_CENTIPAWN_VALUE = 337;
	public final int BISHOP_OPENING_CENTIPAWN_VALUE = 365;
	public final int ROOK_OPENING_CENTIPAWN_VALUE = 477;
	public final int QUEEN_OPENING_CENTIPAWN_VALUE = 1025;
	public final int KING_OPENING_CENTIPAWN_VALUE = 0;

	public final int PAWN_ENDGAME_CENTIPAWN_VALUE = 94;
	public final int KNIGHT_ENDGAME_CENTIPAWN_VALUE = 281;
	public final int BISHOP_ENDGAME_CENTIPAWN_VALUE = 297;
	public final int ROOK_ENDGAME_CENTIPAWN_VALUE = 512;
	public final int QUEEN_ENDGAME_CENTIPAWN_VALUE = 936;
	public final int KING_ENDGAME_CENTIPAWN_VALUE = 0;
	...
	public int getOpeningPieceSquareValue(int row, int column, ChessPiece chessPiece) {
		if (chessPiece instanceof Pawn) {
