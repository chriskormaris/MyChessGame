...
public class GuiConstants {
    ...
    public static final String RULES =
        ...
        + "There are 6 different chess com.chriskormaris.mychessgame.api.piece types: 1) King, 2) Rook, 3) Bishop, 4) Queen, 5) Knight & 6) Pawn. White always plays first.\n"
        + "A chess com.chriskormaris.mychessgame.api.piece can only move to an empty tile or take the place of an opponent's chess com.chriskormaris.mychessgame.api.piece, by capturing it.\n"
        + "However, no chess com.chriskormaris.mychessgame.api.piece can't jump over other chess pieces, unless it is a Knight.\n"
        ...
        + "If the player makes a move with a com.chriskormaris.mychessgame.api.piece that checks the opponent King, in a way that the opponent player has no legal moves for his King,\n"
        + "and he can't block the threat with another com.chriskormaris.mychessgame.api.piece, that move is called a \"checkmate\" and the player that made the move wins the game.\n"
        ...
        + "  3. If 50 turns have passed and neither player has captured any opponent's chess com.chriskormaris.mychessgame.api.piece, then the player that plays next can declare a draw.\n"
        ...
        + "  1) The King can move only one tile in each direction. It can't move to a tile, where it will be threatened by an opponent's com.chriskormaris.mychessgame.api.piece.\n"
        ...
        + "  4) The Queen can move any number of tiles diagonally, horizontally or vertically. It is the strongest com.chriskormaris.mychessgame.api.piece in the game.\n"
        + "  5) The Knight moves in an \"L\"-shape, after moving two tiles either forward, backwards, left or right. It is the only com.chriskormaris.mychessgame.api.piece that can jump over other pieces.\n"
        + "  6) The Pawn can move one tile forward, or 2 tiles forward, if moving for the 1st time. It can capture an opponent's com.chriskormaris.mychessgame.api.piece by moving one tile diagonally.\n"
