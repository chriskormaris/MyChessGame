...
public class PeSTOEvaluation extends Evaluation {
	...
	private static final int PAWN_OPENING_CENTIPAWN_VALUE = 82;
	private static final int KNIGHT_OPENING_CENTIPAWN_VALUE = 337;
	private static final int BISHOP_OPENING_CENTIPAWN_VALUE = 365;
	private static final int ROOK_OPENING_CENTIPAWN_VALUE = 477;
	private static final int QUEEN_OPENING_CENTIPAWN_VALUE = 1025;
	private static final int KING_OPENING_CENTIPAWN_VALUE = 0;

	private static final int PAWN_ENDGAME_CENTIPAWN_VALUE = 94;
	private static final int KNIGHT_ENDGAME_CENTIPAWN_VALUE = 281;
	private static final int BISHOP_ENDGAME_CENTIPAWN_VALUE = 297;
	private static final int ROOK_ENDGAME_CENTIPAWN_VALUE = 512;
	private static final int QUEEN_ENDGAME_CENTIPAWN_VALUE = 936;
	private static final int KING_ENDGAME_CENTIPAWN_VALUE = 0;
	...
	private int getOpeningPieceSquareValue(int row, int column, ChessPiece chessPiece) {
		if (chessPiece instanceof Pawn) {
